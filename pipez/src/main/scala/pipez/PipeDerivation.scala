...
object PipeDerivation extends PipeDerivationPlatform {
  ...
  implicit def contextFunction[Ctx]: PipeDerivation.Aux[Function2[*, Ctx, *], Ctx, IdentityResult] =
    contextFunction[Ctx]()
}
