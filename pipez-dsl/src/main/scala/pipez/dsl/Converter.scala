...
object Converter extends ConverterCompanionCompat with ConverterInstances0 {
  ...
  implicit val pipeDerivation: pipez.PipeDerivation.Simple[Converter] = ConverterDerivationDefinition
}
