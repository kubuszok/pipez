...
object ContextCodec extends ContextCodecCompanionCompat {
  ...
  type ContextCodecResult[A] = Either[List[String], A]

  implicit val pipeDerivation: PipeDerivation.Aux[ContextCodec, Driver, ContextCodecResult] =
    new PipeDerivation[ContextCodec] {
